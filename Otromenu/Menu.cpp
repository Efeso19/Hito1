 ...
 * Author: alfon
 * 
 * Created on 13 de marzo de 2016, 15:46
 */
            ...
            switch(event.key.code) {
                ...
                case sf::Keyboard::Down:
                    if(mostrarMenuppal){
                        ...
                        std::cout<<GetPressedItem()<<std::endl;
                    }
                    if(enPausa){
...
void Menu::submenu(sf::RenderWindow& window){
    ...
    sf::RectangleShape *fondo = new sf::RectangleShape(sf::Vector2f(window.getSize().x, window.getSize().y));
    sf::Color transparente(255,255,255,128);
